    ...
    <x-slot name="header">
        <div class="flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-slate-400 text-[10px] font-bold uppercase tracking-[0.2em] mt-0.5">Penyesuaian Arsip: {{ $aktaNikah->nomor_akta }}</p>
            </div>
        </div>
    </x-slot>

    <div class="max-w-5xl mx-auto space-y-10 pb-20">
        <form method="POST" action="{{ route('akta-nikah.update', $aktaNikah) }}" enctype="multipart/form-data" class="space-y-10">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white rounded-[3rem] shadow-sm border border-slate-100 overflow-hidden transform transition-all duration-500 hover:shadow-xl hover:shadow-slate-200/40">
                ...
                <div class="p-8 md:p-12 grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="space-y-3">
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Nomor Akta <span class="text-rose-500 font-black">*</span></label>
                        <input type="text" name="nomor_akta" value="{{ old('nomor_akta', $aktaNikah->nomor_akta) }}" required
                    ...
                    <div class="space-y-3">
                        ...
                        <input type="text" name="nomor_buku" value="{{ old('nomor_buku', $aktaNikah->nomor_buku) }}"
                               class="w-full px-8 py-5 bg-slate-50 border-slate-100 rounded-[1.4rem] focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all font-bold text-slate-700 shadow-inner">
                    </div>
                    <div class="space-y-3">
                        ...
                        <input type="date" name="tanggal_akad" value="{{ old('tanggal_akad', $aktaNikah->tanggal_akad?->format('Y-m-d')) }}" required
                               class="w-full px-8 py-5 bg-slate-50 border-slate-100 rounded-[1.4rem] focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all font-bold text-slate-700 shadow-inner">
                    </div>
                    <div class="space-y-3">
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Lokasi Akad</label>
                        <input type="text" name="lokasi_akad" value="{{ old('lokasi_akad', $aktaNikah->lokasi_akad) }}"
                               class="w-full px-8 py-5 bg-slate-50 border-slate-100 rounded-[1.4rem] focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all font-bold text-slate-700 shadow-inner">
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-[3rem] shadow-sm border border-slate-100 overflow-hidden group hover:shadow-xl transition-all duration-500">
                    ...
                    <div class="p-8 md:p-10 space-y-8">
                        <div class="space-y-3">
                            ...
                            <input type="text" name="nama_suami" value="{{ old('nama_suami', $aktaNikah->nama_suami) }}" required
                                   class="w-full px-8 py-5 bg-slate-50 border-slate-100 rounded-[1.4rem] focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all font-bold text-slate-700 shadow-inner">
                        </div>
                        <div class="space-y-3">
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">NIK Suami</label>
                            <input type="text" name="nik_suami" value="{{ old('nik_suami', $aktaNikah->nik_suami) }}" maxlength="20"
                                   class="w-full px-8 py-5 bg-slate-50 border-slate-100 rounded-[1.4rem] focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all font-bold text-slate-700 shadow-inner">
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-3">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Tempat Lahir</label>
                                <input type="text" name="tempat_lahir_suami" value="{{ old('tempat_lahir_suami', $aktaNikah->tempat_lahir_suami) }}"
                            ...
                            <div class="space-y-3">
                                ...
                                <input type="date" name="tanggal_lahir_suami" value="{{ old('tanggal_lahir_suami', $aktaNikah->tanggal_lahir_suami?->format('Y-m-d')) }}"
                                       class="w-full px-5 py-4 bg-slate-50 border-slate-100 rounded-2xl focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 font-bold text-slate-700 shadow-inner text-sm">
                            </div>
                        </div>
                        <div class="space-y-3">
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Alamat Lengkap</label>
                            <textarea name="alamat_suami" rows="3" class="w-full px-8 py-5 bg-slate-50 border-slate-100 rounded-[1.4rem] focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all font-bold text-slate-700 shadow-inner">{{ old('alamat_suami', $aktaNikah->alamat_suami) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[3rem] shadow-sm border border-slate-100 overflow-hidden group hover:shadow-xl transition-all duration-500">
                    ...
                    <div class="p-8 md:p-10 space-y-8">
                        <div class="space-y-3">
                            ...
                            <input type="text" name="nama_istri" value="{{ old('nama_istri', $aktaNikah->nama_istri) }}" required
                                   class="w-full px-8 py-5 bg-slate-50 border-slate-100 rounded-[1.4rem] focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all font-bold text-slate-700 shadow-inner">
                        </div>
                        <div class="space-y-3">
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">NIK Istri</label>
                            <input type="text" name="nik_istri" value="{{ old('nik_istri', $aktaNikah->nik_istri) }}" maxlength="20"
                                   class="w-full px-8 py-5 bg-slate-50 border-slate-100 rounded-[1.4rem] focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all font-bold text-slate-700 shadow-inner">
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-3">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Tempat Lahir</label>
                                <input type="text" name="tempat_lahir_istri" value="{{ old('tempat_lahir_istri', $aktaNikah->tempat_lahir_istri) }}"
                                       class="w-full px-5 py-4 bg-slate-50 border-slate-100 rounded-2xl focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 font-bold text-slate-700 shadow-inner text-sm">
                            </div>
                            <div class="space-y-3">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Tgl Lahir</label>
                                <input type="date" name="tanggal_lahir_istri" value="{{ old('tanggal_lahir_istri', $aktaNikah->tanggal_lahir_istri?->format('Y-m-d')) }}"
                                       class="w-full px-5 py-4 bg-slate-50 border-slate-100 rounded-2xl focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 font-bold text-slate-700 shadow-inner text-sm">
                            </div>
                        </div>
                        <div class="space-y-3">
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Alamat Lengkap</label>
                            <textarea name="alamat_istri" rows="3" class="w-full px-8 py-5 bg-slate-50 border-slate-100 rounded-[1.4rem] focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all font-bold text-slate-700 shadow-inner">{{ old('alamat_istri', $aktaNikah->alamat_istri) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="lg:col-span-6 space-y-10">
                        ...
                        <div class="space-y-6">
                            <div class="space-y-3">
                                ...
                                <input type="text" name="nama_wali" value="{{ old('nama_wali', $aktaNikah->nama_wali) }}"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-3">
                                    ...
                                    <select name="jenis_wali" class="w-full bg-white/5 border-white/10 rounded-[1.2rem] px-6 py-5 focus:ring-4 focus:ring-teal-500/20 focus:border-teal-500 font-black">
                                        ...
                                        <option value="nasab" {{ old('jenis_wali', $aktaNikah->jenis_wali) == 'nasab' ? 'selected' : '' }} class="bg-slate-900">Nasab</option>
                                        <option value="hakim" {{ old('jenis_wali', $aktaNikah->jenis_wali) == 'hakim' ? 'selected' : '' }} class="bg-slate-900">Hakim</option>
                                    </select>
                                </div>
                                <div class="space-y-3">
                                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-2">Mas Kawin</label>
                                    <input type="text" name="mas_kawin" value="{{ old('mas_kawin', $aktaNikah->mas_kawin) }}"
                            ...
                            <div class="space-y-3">
                                ...
                                <input type="text" name="penghulu" value="{{ old('penghulu', $aktaNikah->penghulu) }}"
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div class="space-y-3">
                                    ...
                                    <select name="kategori" class="w-full bg-white/5 border-white/10 rounded-[1.2rem] px-6 py-5 focus:ring-4 focus:ring-teal-500/20 focus:border-teal-500 font-black">
                                        <option value="" class="bg-slate-900">Pilih</option>
                                        <option value="Lama" {{ old('kategori', $aktaNikah->kategori) == 'Lama' ? 'selected' : '' }} class="bg-slate-900">Lama</option>
                                        <option value="Baru" {{ old('kategori', $aktaNikah->kategori) == 'Baru' ? 'selected' : '' }} class="bg-slate-900">Baru</option>
                                        <option value="Duplikat" {{ old('kategori', $aktaNikah->kategori) == 'Duplikat' ? 'selected' : '' }} class="bg-slate-900">Duplikat</option>
                                    </select>
                                </div>
                                <div class="space-y-3">
                                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-2">Lokasi Rak/Fisik</label>
                                    <input type="text" name="lokasi_fisik" value="{{ old('lokasi_fisik', $aktaNikah->lokasi_fisik) }}" placeholder="Contoh: Rak B-12"
                                           class="w-full bg-white/5 border-white/10 rounded-[1.2rem] px-6 py-5 focus:ring-4 focus:ring-teal-500/20 focus:border-teal-500 font-black">
                                </div>
                            </div>
                                    ...
                                    @if($aktaNikah->file_path)
                                        <div class="px-6 py-4 bg-teal-500/10 border border-teal-500/20 rounded-2xl flex items-center justify-between group/file">
                                            ...
                                            <a href="{{ asset('storage/' . $aktaNikah->file_path) }}" target="_blank" 
                                               class="text-[10px] font-black text-white px-4 py-2 bg-teal-500/20 rounded-xl hover:bg-teal-500/40 transition-all">
                                                LIHAT FISIK
                                            </a>
                                        </div>
                                    @endif
            ...
            <div class="bg-white rounded-[3rem] p-4 border border-slate-100 shadow-sm flex flex-col md:flex-row items-stretch md:items-center gap-4">
                <div class="flex-1 p-2">
                    <textarea name="keterangan" rows="1" placeholder="Catatan tambahan (opsional)..."
                              class="w-full px-8 py-5 bg-slate-50 border-none rounded-[1.8rem] focus:ring-4 focus:ring-teal-500/10 transition-all font-bold text-slate-700 placeholder:text-slate-300 h-full min-h-[70px]">{{ old('keterangan', $aktaNikah->keterangan) }}</textarea>
                </div>
                <div class="flex gap-4 p-2 shrink-0 h-full">
                    ...
                    <button type="submit" 
                            class="px-14 py-5 bg-amber-500 text-white rounded-[1.8rem] font-black text-center shadow-xl shadow-amber-500/20 hover:bg-amber-600 transition-all active:scale-95 uppercase tracking-widest text-[10px] flex items-center justify-center">
                        SIMPAN PERUBAHAN
                    </button>
                </div>
            </div>
